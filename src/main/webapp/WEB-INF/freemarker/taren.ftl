...
<section>
    <div class="box">
        <div class="box_title">
            ...
            <span style="font-size: .16rem;line-height:.2rem;">${user.name}</span>
            <span id="more"> 男</span>
        </div>
        <hr/>
        <p class="box_text">
            <span class="ttl">收入</span>    <span class="amout_real">￥${user.income}</span>
            </p>
        <hr/>
        <p class="box_text">
            <span class="ttl">地区</span>    <span class="amout_real">${user.position}</span>
        </p>
        <hr/>
        <p class="box_text">
            ${user.idesc}
        ...
        <hr/>
        <div onclick="location.href='sub.html?uid=${user.uid}'" class="zan">
            <span class="fabu tt1">发布</span>
            <span class="amout_real">${user.artNum}</span>
            <span id="back_btn">> </span>
        </div>
    </div>
    <a class="btn" href="msg_item.html?other=${user.uid}">发消息</a>
</section>
</body>
</html>